...
// 0x0748 (0x0870 - 0x0128)
class UExtrudeMeshSelectionTool final : public USingleTargetWithSelectionTool
{
public:
	class UExtrudeMeshSelectionToolProperties*    ExtrudeProperties;                                 // 0x0128(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_130[0x720];                                    // 0x0130(0x0720)(Fixing Size After Last Property [ Dumper-7 ])
	class UPreviewMesh*                           SourcePreview;                                     // 0x0850(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMeshOpPreviewWithBackgroundCompute*    EditCompute;                                       // 0x0858(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCombinedTransformGizmo*                TransformGizmo;                                    // 0x0860(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UTransformProxy*                        TransformProxy;                                    // 0x0868(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UExtrudeMeshSelectionTool) == 0x000870, "Wrong size on UExtrudeMeshSelectionTool");
static_assert(offsetof(UExtrudeMeshSelectionTool, ExtrudeProperties) == 0x000128, "Member 'UExtrudeMeshSelectionTool::ExtrudeProperties' has a wrong offset!");
static_assert(offsetof(UExtrudeMeshSelectionTool, SourcePreview) == 0x000850, "Member 'UExtrudeMeshSelectionTool::SourcePreview' has a wrong offset!");
static_assert(offsetof(UExtrudeMeshSelectionTool, EditCompute) == 0x000858, "Member 'UExtrudeMeshSelectionTool::EditCompute' has a wrong offset!");
static_assert(offsetof(UExtrudeMeshSelectionTool, TransformGizmo) == 0x000860, "Member 'UExtrudeMeshSelectionTool::TransformGizmo' has a wrong offset!");
static_assert(offsetof(UExtrudeMeshSelectionTool, TransformProxy) == 0x000868, "Member 'UExtrudeMeshSelectionTool::TransformProxy' has a wrong offset!");
...
{
public:
	class USplitMeshesToolProperties*             BasicProperties;                                   // 0x00C0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USplitMeshesTool) == 0x0000F8, "Wrong size on USplitMeshesTool");
static_assert(offsetof(USplitMeshesTool, BasicProperties) == 0x0000C0, "Member 'USplitMeshesTool::BasicProperties' has a wrong offset!");
static_assert(offsetof(USplitMeshesTool, OutputTypeProperties) == 0x0000C8, "Member 'USplitMeshesTool::OutputTypeProperties' has a wrong offset!");
...
public:
	...
	class UTriangulateSplinesToolProperties*      TriangulateProperties;                             // 0x00B0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	class UMeshOpPreviewWithBackgroundCompute*    Preview;                                           // 0x00C0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TWeakObjectPtr<class UWorld>                  TargetWorld;                                       // 0x00C8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<TWeakObjectPtr<class AActor>>          ActorsWithSplines;                                 // 0x00D0(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UTriangulateSplinesTool) == 0x000100, "Wrong size on UTriangulateSplinesTool");
static_assert(offsetof(UTriangulateSplinesTool, TriangulateProperties) == 0x0000B0, "Member 'UTriangulateSplinesTool::TriangulateProperties' has a wrong offset!");
static_assert(offsetof(UTriangulateSplinesTool, OutputTypeProperties) == 0x0000B8, "Member 'UTriangulateSplinesTool::OutputTypeProperties' has a wrong offset!");
static_assert(offsetof(UTriangulateSplinesTool, Preview) == 0x0000C0, "Member 'UTriangulateSplinesTool::Preview' has a wrong offset!");
static_assert(offsetof(UTriangulateSplinesTool, TargetWorld) == 0x0000C8, "Member 'UTriangulateSplinesTool::TargetWorld' has a wrong offset!");
static_assert(offsetof(UTriangulateSplinesTool, ActorsWithSplines) == 0x0000D0, "Member 'UTriangulateSplinesTool::ActorsWithSplines' has a wrong offset!");
...
{
public:
	class UOffsetMeshSelectionToolProperties*     OffsetProperties;                                  // 0x0128(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_130[0x720];                                    // 0x0130(0x0720)(Fixing Size After Last Property [ Dumper-7 ])
	class UPreviewMesh*                           SourcePreview;                                     // 0x0850(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMeshOpPreviewWithBackgroundCompute*    EditCompute;                                       // 0x0858(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UOffsetMeshSelectionTool) == 0x000860, "Wrong size on UOffsetMeshSelectionTool");
static_assert(offsetof(UOffsetMeshSelectionTool, OffsetProperties) == 0x000128, "Member 'UOffsetMeshSelectionTool::OffsetProperties' has a wrong offset!");
static_assert(offsetof(UOffsetMeshSelectionTool, SourcePreview) == 0x000850, "Member 'UOffsetMeshSelectionTool::SourcePreview' has a wrong offset!");
static_assert(offsetof(UOffsetMeshSelectionTool, EditCompute) == 0x000858, "Member 'UOffsetMeshSelectionTool::EditCompute' has a wrong offset!");
...
{
public:
	class UPatternToolSettings*                   Settings;                                          // 0x00C0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPatternTool_BoundingBoxSettings*       BoundingBoxSettings;                               // 0x00C8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPatternTool_LinearSettings*            LinearSettings;                                    // 0x00D0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPatternTool_GridSettings*              GridSettings;                                      // 0x00D8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPatternTool_RadialSettings*            RadialSettings;                                    // 0x00E0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPatternTool_RotationSettings*          RotationSettings;                                  // 0x00E8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPatternTool_TranslationSettings*       TranslationSettings;                               // 0x00F0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPatternTool_ScaleSettings*             ScaleSettings;                                     // 0x00F8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_100[0x58];                                     // 0x0100(0x0058)(Fixing Size After Last Property [ Dumper-7 ])
	class UPatternTool_OutputSettings*            OutputSettings;                                    // 0x0158(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_160[0x48];                                     // 0x0160(0x0048)(Fixing Size After Last Property [ Dumper-7 ])
	class UTransformProxy*                        PatternGizmoProxy;                                 // 0x01A8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCombinedTransformGizmo*                PatternGizmo;                                      // 0x01B0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1B8[0x18];                                     // 0x01B8(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	class UDragAlignmentMechanic*                 DragAlignmentMechanic;                             // 0x01D0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UConstructionPlaneMechanic*             PlaneMechanic;                                     // 0x01D8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1E0[0x1E8];                                    // 0x01E0(0x01E8)(Fixing Size After Last Property [ Dumper-7 ])
	TSet<class UPrimitiveComponent*>              AllComponents;                                     // 0x03C8(0x0050)(ExportObject, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                         Pad_418[0xA0];                                     // 0x0418(0x00A0)(Fixing Size After Last Property [ Dumper-7 ])
	class UPreviewGeometry*                       PreviewGeometry;                                   // 0x04B8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UPatternTool) == 0x0004C0, "Wrong size on UPatternTool");
static_assert(offsetof(UPatternTool, Settings) == 0x0000C0, "Member 'UPatternTool::Settings' has a wrong offset!");
static_assert(offsetof(UPatternTool, BoundingBoxSettings) == 0x0000C8, "Member 'UPatternTool::BoundingBoxSettings' has a wrong offset!");
static_assert(offsetof(UPatternTool, LinearSettings) == 0x0000D0, "Member 'UPatternTool::LinearSettings' has a wrong offset!");
static_assert(offsetof(UPatternTool, GridSettings) == 0x0000D8, "Member 'UPatternTool::GridSettings' has a wrong offset!");
static_assert(offsetof(UPatternTool, RadialSettings) == 0x0000E0, "Member 'UPatternTool::RadialSettings' has a wrong offset!");
static_assert(offsetof(UPatternTool, RotationSettings) == 0x0000E8, "Member 'UPatternTool::RotationSettings' has a wrong offset!");
static_assert(offsetof(UPatternTool, TranslationSettings) == 0x0000F0, "Member 'UPatternTool::TranslationSettings' has a wrong offset!");
static_assert(offsetof(UPatternTool, ScaleSettings) == 0x0000F8, "Member 'UPatternTool::ScaleSettings' has a wrong offset!");
static_assert(offsetof(UPatternTool, OutputSettings) == 0x000158, "Member 'UPatternTool::OutputSettings' has a wrong offset!");
static_assert(offsetof(UPatternTool, PatternGizmoProxy) == 0x0001A8, "Member 'UPatternTool::PatternGizmoProxy' has a wrong offset!");
static_assert(offsetof(UPatternTool, PatternGizmo) == 0x0001B0, "Member 'UPatternTool::PatternGizmo' has a wrong offset!");
static_assert(offsetof(UPatternTool, DragAlignmentMechanic) == 0x0001D0, "Member 'UPatternTool::DragAlignmentMechanic' has a wrong offset!");
static_assert(offsetof(UPatternTool, PlaneMechanic) == 0x0001D8, "Member 'UPatternTool::PlaneMechanic' has a wrong offset!");
static_assert(offsetof(UPatternTool, AllComponents) == 0x0003C8, "Member 'UPatternTool::AllComponents' has a wrong offset!");
static_assert(offsetof(UPatternTool, PreviewGeometry) == 0x0004B8, "Member 'UPatternTool::PreviewGeometry' has a wrong offset!");
...
public:
	uint8                                         Pad_A0[0x10];                                      // 0x00A0(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class URevolveSplineToolProperties*           Settings;                                          // 0x00B0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UNewMeshMaterialProperties*             MaterialProperties;                                // 0x00B8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UCreateMeshObjectTypeProperties*        OutputTypeProperties;                              // 0x00C0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class URevolveSplineToolActionPropertySet*    ToolActions;                                       // 0x00C8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	class UConstructionPlaneMechanic*             PlaneMechanic;                                     // 0x00D8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(URevolveSplineTool) == 0x000180, "Wrong size on URevolveSplineTool");
static_assert(offsetof(URevolveSplineTool, Settings) == 0x0000B0, "Member 'URevolveSplineTool::Settings' has a wrong offset!");
static_assert(offsetof(URevolveSplineTool, MaterialProperties) == 0x0000B8, "Member 'URevolveSplineTool::MaterialProperties' has a wrong offset!");
static_assert(offsetof(URevolveSplineTool, OutputTypeProperties) == 0x0000C0, "Member 'URevolveSplineTool::OutputTypeProperties' has a wrong offset!");
static_assert(offsetof(URevolveSplineTool, ToolActions) == 0x0000C8, "Member 'URevolveSplineTool::ToolActions' has a wrong offset!");
static_assert(offsetof(URevolveSplineTool, Preview) == 0x0000D0, "Member 'URevolveSplineTool::Preview' has a wrong offset!");
static_assert(offsetof(URevolveSplineTool, PlaneMechanic) == 0x0000D8, "Member 'URevolveSplineTool::PlaneMechanic' has a wrong offset!");
...
public:
	...
	class UAddPatchToolProperties*                ShapeSettings;                                     // 0x00B0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class UPreviewMesh*                           PreviewMesh;                                       // 0x00C0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UAddPatchTool) == 0x000130, "Wrong size on UAddPatchTool");
static_assert(offsetof(UAddPatchTool, ShapeSettings) == 0x0000B0, "Member 'UAddPatchTool::ShapeSettings' has a wrong offset!");
static_assert(offsetof(UAddPatchTool, MaterialProperties) == 0x0000B8, "Member 'UAddPatchTool::MaterialProperties' has a wrong offset!");
static_assert(offsetof(UAddPatchTool, PreviewMesh) == 0x0000C0, "Member 'UAddPatchTool::PreviewMesh' has a wrong offset!");
...
public:
	...
	class UAlignObjectsToolProperties*            AlignProps;                                        // 0x00C8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAlignObjectsTool) == 0x000160, "Wrong size on UAlignObjectsTool");
static_assert(offsetof(UAlignObjectsTool, AlignProps) == 0x0000C8, "Member 'UAlignObjectsTool::AlignProps' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_F8[0x398];                                     // 0x00F8(0x0398)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	uint8                                         Pad_C0[0x8];                                       // 0x00C0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UConvertMeshesToolProperties*           BasicProperties;                                   // 0x00C8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UCreateMeshObjectTypeProperties*        OutputTypeProperties;                              // 0x00D0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UConvertMeshesTool) == 0x0000D8, "Wrong size on UConvertMeshesTool");
static_assert(offsetof(UConvertMeshesTool, BasicProperties) == 0x0000C8, "Member 'UConvertMeshesTool::BasicProperties' has a wrong offset!");
static_assert(offsetof(UConvertMeshesTool, OutputTypeProperties) == 0x0000D0, "Member 'UConvertMeshesTool::OutputTypeProperties' has a wrong offset!");
...
{
public:
	class UVolumeToMeshToolProperties*            Settings;                                          // 0x00A0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class UPreviewMesh*                           PreviewMesh;                                       // 0x00B0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TLazyObjectPtr<class AVolume>                 TargetVolume;                                      // 0x00B8(0x0018)(IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UVolumeToMeshTool, Settings) == 0x0000A0, "Member 'UVolumeToMeshTool::Settings' has a wrong offset!");
static_assert(offsetof(UVolumeToMeshTool, OutputTypeProperties) == 0x0000A8, "Member 'UVolumeToMeshTool::OutputTypeProperties' has a wrong offset!");
static_assert(offsetof(UVolumeToMeshTool, PreviewMesh) == 0x0000B0, "Member 'UVolumeToMeshTool::PreviewMesh' has a wrong offset!");
static_assert(offsetof(UVolumeToMeshTool, TargetVolume) == 0x0000B8, "Member 'UVolumeToMeshTool::TargetVolume' has a wrong offset!");
...
{
public:
	class UConvertToPolygonsToolProperties*       Settings;                                          // 0x0128(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPolygroupLayersProperties*             CopyFromLayerProperties;                           // 0x0130(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UOutputPolygroupLayerProperties*        OutputProperties;                                  // 0x0138(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMeshOpPreviewWithBackgroundCompute*    PreviewCompute;                                    // 0x0140(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class UPreviewMesh*                           UnmodifiedAreaPreviewMesh;                         // 0x0150(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UConvertToPolygonsTool) == 0x0001C0, "Wrong size on UConvertToPolygonsTool");
static_assert(offsetof(UConvertToPolygonsTool, Settings) == 0x000128, "Member 'UConvertToPolygonsTool::Settings' has a wrong offset!");
static_assert(offsetof(UConvertToPolygonsTool, CopyFromLayerProperties) == 0x000130, "Member 'UConvertToPolygonsTool::CopyFromLayerProperties' has a wrong offset!");
static_assert(offsetof(UConvertToPolygonsTool, OutputProperties) == 0x000138, "Member 'UConvertToPolygonsTool::OutputProperties' has a wrong offset!");
static_assert(offsetof(UConvertToPolygonsTool, PreviewCompute) == 0x000140, "Member 'UConvertToPolygonsTool::PreviewCompute' has a wrong offset!");
static_assert(offsetof(UConvertToPolygonsTool, PreviewGeometry) == 0x000148, "Member 'UConvertToPolygonsTool::PreviewGeometry' has a wrong offset!");
static_assert(offsetof(UConvertToPolygonsTool, UnmodifiedAreaPreviewMesh) == 0x000150, "Member 'UConvertToPolygonsTool::UnmodifiedAreaPreviewMesh' has a wrong offset!");
...
public:
	...
	class UCombinedTransformGizmo*                GridGizmo;                                         // 0x00C8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UDragAlignmentMechanic*                 GridGizmoAlignmentMechanic;                        // 0x00D0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UTransformProxy*                        GridGizmoTransformProxy;                           // 0x00D8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPreviewGeometry*                       LineSets;                                          // 0x00E0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UClickDragInputBehavior*                ClickDragBehavior;                                 // 0x00E8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class ULocalSingleClickInputBehavior*         CtrlMiddleClickBehavior;                           // 0x00F8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class ULocalClickDragInputBehavior*           MiddleClickDragBehavior;                           // 0x0100(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCubeGridToolProperties*                Settings;                                          // 0x0108(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCubeGridToolActions*                   ToolActions;                                       // 0x0110(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCubeGridDuringActivityActions*         DuringActivityActions;                             // 0x0118(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UNewMeshMaterialProperties*             MaterialProperties;                                // 0x0120(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCreateMeshObjectTypeProperties*        OutputTypeProperties;                              // 0x0128(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UToolTarget*                            Target;                                            // 0x0130(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_138[0x180];                                    // 0x0138(0x0180)(Fixing Size After Last Property [ Dumper-7 ])
	class UMeshOpPreviewWithBackgroundCompute*    Preview;                                           // 0x02B8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2C0[0x370];                                    // 0x02C0(0x0370)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UCubeGridTool, GridGizmo) == 0x0000C8, "Member 'UCubeGridTool::GridGizmo' has a wrong offset!");
static_assert(offsetof(UCubeGridTool, GridGizmoAlignmentMechanic) == 0x0000D0, "Member 'UCubeGridTool::GridGizmoAlignmentMechanic' has a wrong offset!");
static_assert(offsetof(UCubeGridTool, GridGizmoTransformProxy) == 0x0000D8, "Member 'UCubeGridTool::GridGizmoTransformProxy' has a wrong offset!");
static_assert(offsetof(UCubeGridTool, LineSets) == 0x0000E0, "Member 'UCubeGridTool::LineSets' has a wrong offset!");
static_assert(offsetof(UCubeGridTool, ClickDragBehavior) == 0x0000E8, "Member 'UCubeGridTool::ClickDragBehavior' has a wrong offset!");
static_assert(offsetof(UCubeGridTool, HoverBehavior) == 0x0000F0, "Member 'UCubeGridTool::HoverBehavior' has a wrong offset!");
static_assert(offsetof(UCubeGridTool, CtrlMiddleClickBehavior) == 0x0000F8, "Member 'UCubeGridTool::CtrlMiddleClickBehavior' has a wrong offset!");
static_assert(offsetof(UCubeGridTool, MiddleClickDragBehavior) == 0x000100, "Member 'UCubeGridTool::MiddleClickDragBehavior' has a wrong offset!");
static_assert(offsetof(UCubeGridTool, Settings) == 0x000108, "Member 'UCubeGridTool::Settings' has a wrong offset!");
static_assert(offsetof(UCubeGridTool, ToolActions) == 0x000110, "Member 'UCubeGridTool::ToolActions' has a wrong offset!");
static_assert(offsetof(UCubeGridTool, DuringActivityActions) == 0x000118, "Member 'UCubeGridTool::DuringActivityActions' has a wrong offset!");
static_assert(offsetof(UCubeGridTool, MaterialProperties) == 0x000120, "Member 'UCubeGridTool::MaterialProperties' has a wrong offset!");
static_assert(offsetof(UCubeGridTool, OutputTypeProperties) == 0x000128, "Member 'UCubeGridTool::OutputTypeProperties' has a wrong offset!");
static_assert(offsetof(UCubeGridTool, Target) == 0x000130, "Member 'UCubeGridTool::Target' has a wrong offset!");
static_assert(offsetof(UCubeGridTool, Preview) == 0x0002B8, "Member 'UCubeGridTool::Preview' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_128[0x16E8];                                   // 0x0128(0x16E8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UDeformMeshPolygonsTool) == 0x001810, "Wrong size on UDeformMeshPolygonsTool");
...
// 0x03B0 (0x0470 - 0x00C0)
class alignas(0x10) UDisplaceMeshTool final : public USingleSelectionMeshEditingTool
{
public:
	class UDisplaceMeshCommonProperties*          CommonProperties;                                  // 0x00C0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UDisplaceMeshDirectionalFilterProperties* DirectionalFilterProperties;                     // 0x00C8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UDisplaceMeshTextureMapProperties*      TextureMapProperties;                              // 0x00D0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UDisplaceMeshPerlinNoiseProperties*     NoiseProperties;                                   // 0x00D8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UDisplaceMeshSineWaveProperties*        SineWaveProperties;                                // 0x00E0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USelectiveTessellationProperties*       SelectiveTessellationProperties;                   // 0x00E8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UCurveFloat*                            ActiveContrastCurveTarget;                         // 0x00F0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMeshStatisticsProperties*              MeshStatistics;                                    // 0x00F8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_100[0x340];                                    // 0x0100(0x0340)(Fixing Size After Last Property [ Dumper-7 ])
	class AInternalToolFrameworkActor*            PreviewMeshActor;                                  // 0x0440(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UDynamicMeshComponent*                  DynamicMeshComponent;                              // 0x0448(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UDisplaceMeshTool) == 0x000470, "Wrong size on UDisplaceMeshTool");
static_assert(offsetof(UDisplaceMeshTool, CommonProperties) == 0x0000C0, "Member 'UDisplaceMeshTool::CommonProperties' has a wrong offset!");
static_assert(offsetof(UDisplaceMeshTool, DirectionalFilterProperties) == 0x0000C8, "Member 'UDisplaceMeshTool::DirectionalFilterProperties' has a wrong offset!");
static_assert(offsetof(UDisplaceMeshTool, TextureMapProperties) == 0x0000D0, "Member 'UDisplaceMeshTool::TextureMapProperties' has a wrong offset!");
static_assert(offsetof(UDisplaceMeshTool, NoiseProperties) == 0x0000D8, "Member 'UDisplaceMeshTool::NoiseProperties' has a wrong offset!");
static_assert(offsetof(UDisplaceMeshTool, SineWaveProperties) == 0x0000E0, "Member 'UDisplaceMeshTool::SineWaveProperties' has a wrong offset!");
static_assert(offsetof(UDisplaceMeshTool, SelectiveTessellationProperties) == 0x0000E8, "Member 'UDisplaceMeshTool::SelectiveTessellationProperties' has a wrong offset!");
static_assert(offsetof(UDisplaceMeshTool, ActiveContrastCurveTarget) == 0x0000F0, "Member 'UDisplaceMeshTool::ActiveContrastCurveTarget' has a wrong offset!");
static_assert(offsetof(UDisplaceMeshTool, MeshStatistics) == 0x0000F8, "Member 'UDisplaceMeshTool::MeshStatistics' has a wrong offset!");
static_assert(offsetof(UDisplaceMeshTool, PreviewMeshActor) == 0x000440, "Member 'UDisplaceMeshTool::PreviewMeshActor' has a wrong offset!");
static_assert(offsetof(UDisplaceMeshTool, DynamicMeshComponent) == 0x000448, "Member 'UDisplaceMeshTool::DynamicMeshComponent' has a wrong offset!");
...
{
public:
	class UPreviewMesh*                           PreviewMesh;                                       // 0x0290(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UDynamicMeshBrushTool, PreviewMesh) == 0x000290, "Member 'UDynamicMeshBrushTool::PreviewMesh' has a wrong offset!");
...
// 0x0F18 (0x1020 - 0x0108)
class alignas(0x10) UDynamicMeshSculptTool final : public UMeshSurfacePointTool
{
public:
	class UDynamicMeshBrushProperties*            BrushProperties;                                   // 0x0108(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UDynamicMeshBrushSculptProperties*      SculptProperties;                                  // 0x0110(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USculptMaxBrushProperties*              SculptMaxBrushProperties;                          // 0x0118(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UKelvinBrushProperties*                 KelvinBrushProperties;                             // 0x0120(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UBrushRemeshProperties*                 RemeshProperties;                                  // 0x0128(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFixedPlaneBrushProperties*             GizmoProperties;                                   // 0x0130(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMeshEditingViewProperties*             ViewProperties;                                    // 0x0138(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UDynamicSculptToolActions*              SculptToolActions;                                 // 0x0140(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_1D0[0xE30];                                    // 0x01D0(0x0E30)(Fixing Size After Last Property [ Dumper-7 ])
	class UCombinedTransformGizmo*                PlaneTransformGizmo;                               // 0x1000(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UTransformProxy*                        PlaneTransformProxy;                               // 0x1008(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UDynamicMeshSculptTool, BrushProperties) == 0x000108, "Member 'UDynamicMeshSculptTool::BrushProperties' has a wrong offset!");
static_assert(offsetof(UDynamicMeshSculptTool, SculptProperties) == 0x000110, "Member 'UDynamicMeshSculptTool::SculptProperties' has a wrong offset!");
static_assert(offsetof(UDynamicMeshSculptTool, SculptMaxBrushProperties) == 0x000118, "Member 'UDynamicMeshSculptTool::SculptMaxBrushProperties' has a wrong offset!");
static_assert(offsetof(UDynamicMeshSculptTool, KelvinBrushProperties) == 0x000120, "Member 'UDynamicMeshSculptTool::KelvinBrushProperties' has a wrong offset!");
static_assert(offsetof(UDynamicMeshSculptTool, RemeshProperties) == 0x000128, "Member 'UDynamicMeshSculptTool::RemeshProperties' has a wrong offset!");
static_assert(offsetof(UDynamicMeshSculptTool, GizmoProperties) == 0x000130, "Member 'UDynamicMeshSculptTool::GizmoProperties' has a wrong offset!");
static_assert(offsetof(UDynamicMeshSculptTool, ViewProperties) == 0x000138, "Member 'UDynamicMeshSculptTool::ViewProperties' has a wrong offset!");
static_assert(offsetof(UDynamicMeshSculptTool, SculptToolActions) == 0x000140, "Member 'UDynamicMeshSculptTool::SculptToolActions' has a wrong offset!");
...
static_assert(offsetof(UDynamicMeshSculptTool, PlaneTransformGizmo) == 0x001000, "Member 'UDynamicMeshSculptTool::PlaneTransformGizmo' has a wrong offset!");
static_assert(offsetof(UDynamicMeshSculptTool, PlaneTransformProxy) == 0x001008, "Member 'UDynamicMeshSculptTool::PlaneTransformProxy' has a wrong offset!");
...
static_assert(sizeof(UEditNormalsTool) == 0x000220, "Wrong size on UEditNormalsTool");
...
public:
	uint8                                         Pad_C0[0x8];                                       // 0x00C0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class URemeshMeshToolProperties*              BasicProperties;                                   // 0x00C8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMeshStatisticsProperties*              MeshStatisticsProperties;                          // 0x00D0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMeshOpPreviewWithBackgroundCompute*    Preview;                                           // 0x00D8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMeshElementsVisualizer*                MeshElementsDisplay;                               // 0x00E0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(URemeshMeshTool) == 0x000110, "Wrong size on URemeshMeshTool");
static_assert(offsetof(URemeshMeshTool, BasicProperties) == 0x0000C8, "Member 'URemeshMeshTool::BasicProperties' has a wrong offset!");
static_assert(offsetof(URemeshMeshTool, MeshStatisticsProperties) == 0x0000D0, "Member 'URemeshMeshTool::MeshStatisticsProperties' has a wrong offset!");
static_assert(offsetof(URemeshMeshTool, Preview) == 0x0000D8, "Member 'URemeshMeshTool::Preview' has a wrong offset!");
static_assert(offsetof(URemeshMeshTool, MeshElementsDisplay) == 0x0000E0, "Member 'URemeshMeshTool::MeshElementsDisplay' has a wrong offset!");
...
static_assert(sizeof(UProjectToTargetTool) == 0x000120, "Wrong size on UProjectToTargetTool");
...
{
public:
	class USmoothHoleFillProperties*              SmoothHoleFillProperties;                          // 0x00C0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UHoleFillToolProperties*                properties;                                        // 0x00C8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UHoleFillToolActions*                   Actions;                                           // 0x00D0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UHoleFillStatisticsProperties*          Statistics;                                        // 0x00D8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class UBoundarySelectionMechanic*             SelectionMechanic;                                 // 0x00E8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UHoleFillTool) == 0x000250, "Wrong size on UHoleFillTool");
static_assert(offsetof(UHoleFillTool, SmoothHoleFillProperties) == 0x0000C0, "Member 'UHoleFillTool::SmoothHoleFillProperties' has a wrong offset!");
static_assert(offsetof(UHoleFillTool, properties) == 0x0000C8, "Member 'UHoleFillTool::properties' has a wrong offset!");
static_assert(offsetof(UHoleFillTool, Actions) == 0x0000D0, "Member 'UHoleFillTool::Actions' has a wrong offset!");
static_assert(offsetof(UHoleFillTool, Statistics) == 0x0000D8, "Member 'UHoleFillTool::Statistics' has a wrong offset!");
static_assert(offsetof(UHoleFillTool, Preview) == 0x0000E0, "Member 'UHoleFillTool::Preview' has a wrong offset!");
static_assert(offsetof(UHoleFillTool, SelectionMechanic) == 0x0000E8, "Member 'UHoleFillTool::SelectionMechanic' has a wrong offset!");
...
{
public:
	class URemoveOccludedTrianglesToolProperties* BasicProperties;                                   // 0x00C0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPolygroupLayersProperties*             PolygroupLayersProperties;                         // 0x00C8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class URemoveOccludedTrianglesAdvancedProperties* AdvancedProperties;                            // 0x00D0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	TArray<class UPreviewMesh*>                   PreviewCopies;                                     // 0x00E8(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
static_assert(sizeof(URemoveOccludedTrianglesTool) == 0x0001E0, "Wrong size on URemoveOccludedTrianglesTool");
static_assert(offsetof(URemoveOccludedTrianglesTool, BasicProperties) == 0x0000C0, "Member 'URemoveOccludedTrianglesTool::BasicProperties' has a wrong offset!");
static_assert(offsetof(URemoveOccludedTrianglesTool, PolygroupLayersProperties) == 0x0000C8, "Member 'URemoveOccludedTrianglesTool::PolygroupLayersProperties' has a wrong offset!");
static_assert(offsetof(URemoveOccludedTrianglesTool, AdvancedProperties) == 0x0000D0, "Member 'URemoveOccludedTrianglesTool::AdvancedProperties' has a wrong offset!");
static_assert(offsetof(URemoveOccludedTrianglesTool, Previews) == 0x0000D8, "Member 'URemoveOccludedTrianglesTool::Previews' has a wrong offset!");
static_assert(offsetof(URemoveOccludedTrianglesTool, PreviewCopies) == 0x0000E8, "Member 'URemoveOccludedTrianglesTool::PreviewCopies' has a wrong offset!");
...
public:
	...
	class ULatticeControlPointsMechanic*          ControlPointsMechanic;                             // 0x00E0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class ULatticeDeformerToolProperties*         Settings;                                          // 0x00E8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	bool                                          bLatticeDeformed;                                  // 0x00F8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ULatticeDeformerTool) == 0x000168, "Wrong size on ULatticeDeformerTool");
static_assert(offsetof(ULatticeDeformerTool, ControlPointsMechanic) == 0x0000E0, "Member 'ULatticeDeformerTool::ControlPointsMechanic' has a wrong offset!");
static_assert(offsetof(ULatticeDeformerTool, Settings) == 0x0000E8, "Member 'ULatticeDeformerTool::Settings' has a wrong offset!");
static_assert(offsetof(ULatticeDeformerTool, Preview) == 0x0000F0, "Member 'ULatticeDeformerTool::Preview' has a wrong offset!");
static_assert(offsetof(ULatticeDeformerTool, bLatticeDeformed) == 0x0000F8, "Member 'ULatticeDeformerTool::bLatticeDeformed' has a wrong offset!");
...
{
public:
	class UMeshAttributePaintBrushOperationProperties* BrushActionProps;                             // 0x02D0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMeshAttributePaintToolProperties*      AttribProps;                                       // 0x02D8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2E0[0x4E0];                                    // 0x02E0(0x04E0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMeshAttributePaintTool) == 0x0007C0, "Wrong size on UMeshAttributePaintTool");
static_assert(offsetof(UMeshAttributePaintTool, BrushActionProps) == 0x0002D0, "Member 'UMeshAttributePaintTool::BrushActionProps' has a wrong offset!");
static_assert(offsetof(UMeshAttributePaintTool, AttribProps) == 0x0002D8, "Member 'UMeshAttributePaintTool::AttribProps' has a wrong offset!");
...
// 0x0A98 (0x0BA0 - 0x0108)
#pragma pack(push, 0x1)
class alignas(0x10) UMeshSculptToolBase : public UMeshSurfacePointTool
{
public:
	class USculptBrushProperties*                 BrushProperties;                                   // 0x0108(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UWorkPlaneProperties*                   GizmoProperties;                                   // 0x0110(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_118[0x118];                                    // 0x0118(0x0118)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UMeshSculptToolBase, BrushProperties) == 0x000108, "Member 'UMeshSculptToolBase::BrushProperties' has a wrong offset!");
static_assert(offsetof(UMeshSculptToolBase, GizmoProperties) == 0x000110, "Member 'UMeshSculptToolBase::GizmoProperties' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_BE8[0x3E8];                                    // 0x0BE8(0x03E8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMeshGroupPaintTool) == 0x000FD0, "Wrong size on UMeshGroupPaintTool");
...
{
public:
	class UMeshInspectorProperties*               Settings;                                          // 0x00C0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPolygroupLayersProperties*             PolygroupLayerProperties;                          // 0x00C8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMeshInspectorMaterialProperties*       MaterialSettings;                                  // 0x00D0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class UMaterialInterface*                     DefaultMaterial;                                   // 0x00F0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_F8[0x168];                                     // 0x00F8(0x0168)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMeshInspectorTool) == 0x000260, "Wrong size on UMeshInspectorTool");
static_assert(offsetof(UMeshInspectorTool, Settings) == 0x0000C0, "Member 'UMeshInspectorTool::Settings' has a wrong offset!");
static_assert(offsetof(UMeshInspectorTool, PolygroupLayerProperties) == 0x0000C8, "Member 'UMeshInspectorTool::PolygroupLayerProperties' has a wrong offset!");
static_assert(offsetof(UMeshInspectorTool, MaterialSettings) == 0x0000D0, "Member 'UMeshInspectorTool::MaterialSettings' has a wrong offset!");
static_assert(offsetof(UMeshInspectorTool, PreviewMesh) == 0x0000E0, "Member 'UMeshInspectorTool::PreviewMesh' has a wrong offset!");
static_assert(offsetof(UMeshInspectorTool, DrawnLineSet) == 0x0000E8, "Member 'UMeshInspectorTool::DrawnLineSet' has a wrong offset!");
static_assert(offsetof(UMeshInspectorTool, DefaultMaterial) == 0x0000F0, "Member 'UMeshInspectorTool::DefaultMaterial' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_380[0x378];                                    // 0x0380(0x0378)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMeshSelectionTool) == 0x0006F8, "Wrong size on UMeshSelectionTool");
static_assert(offsetof(UMeshSelectionTool, SelectionProps) == 0x0002D8, "Member 'UMeshSelectionTool::SelectionProps' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, SelectionActions) == 0x0002E0, "Member 'UMeshSelectionTool::SelectionActions' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, EditActions) == 0x0002E8, "Member 'UMeshSelectionTool::EditActions' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, MeshStatisticsProperties) == 0x0002F0, "Member 'UMeshSelectionTool::MeshStatisticsProperties' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, MeshElementsDisplay) == 0x0002F8, "Member 'UMeshSelectionTool::MeshElementsDisplay' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, UVChannelProperties) == 0x000300, "Member 'UMeshSelectionTool::UVChannelProperties' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, PolygroupLayerProperties) == 0x000308, "Member 'UMeshSelectionTool::PolygroupLayerProperties' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, Selection) == 0x000368, "Member 'UMeshSelectionTool::Selection' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, SpawnedActors) == 0x000370, "Member 'UMeshSelectionTool::SpawnedActors' has a wrong offset!");
...
{
public:
	class UMeshSpaceDeformerToolProperties*       Settings;                                          // 0x00C0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMeshSpaceDeformerToolActionPropertySet* ToolActions;                                      // 0x00C8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UGizmoTransformChangeStateTarget*       StateTarget;                                       // 0x00D0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class UMeshOpPreviewWithBackgroundCompute*    Preview;                                           // 0x00E0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_E8[0x10];                                      // 0x00E8(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class UPreviewMesh*                           OriginalMeshPreview;                               // 0x00F8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UIntervalGizmo*                         IntervalGizmo;                                     // 0x0100(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class UGizmoLocalFloatParameterSource*        UpIntervalSource;                                  // 0x0118(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UGizmoLocalFloatParameterSource*        DownIntervalSource;                                // 0x0120(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UGizmoLocalFloatParameterSource*        ForwardIntervalSource;                             // 0x0128(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMeshSpaceDeformerTool) == 0x0002D0, "Wrong size on UMeshSpaceDeformerTool");
static_assert(offsetof(UMeshSpaceDeformerTool, Settings) == 0x0000C0, "Member 'UMeshSpaceDeformerTool::Settings' has a wrong offset!");
static_assert(offsetof(UMeshSpaceDeformerTool, ToolActions) == 0x0000C8, "Member 'UMeshSpaceDeformerTool::ToolActions' has a wrong offset!");
...
static_assert(offsetof(UMeshSpaceDeformerTool, DragAlignmentMechanic) == 0x0000D8, "Member 'UMeshSpaceDeformerTool::DragAlignmentMechanic' has a wrong offset!");
static_assert(offsetof(UMeshSpaceDeformerTool, Preview) == 0x0000E0, "Member 'UMeshSpaceDeformerTool::Preview' has a wrong offset!");
static_assert(offsetof(UMeshSpaceDeformerTool, OriginalMeshPreview) == 0x0000F8, "Member 'UMeshSpaceDeformerTool::OriginalMeshPreview' has a wrong offset!");
static_assert(offsetof(UMeshSpaceDeformerTool, IntervalGizmo) == 0x000100, "Member 'UMeshSpaceDeformerTool::IntervalGizmo' has a wrong offset!");
static_assert(offsetof(UMeshSpaceDeformerTool, TransformGizmo) == 0x000108, "Member 'UMeshSpaceDeformerTool::TransformGizmo' has a wrong offset!");
static_assert(offsetof(UMeshSpaceDeformerTool, TransformProxy) == 0x000110, "Member 'UMeshSpaceDeformerTool::TransformProxy' has a wrong offset!");
static_assert(offsetof(UMeshSpaceDeformerTool, UpIntervalSource) == 0x000118, "Member 'UMeshSpaceDeformerTool::UpIntervalSource' has a wrong offset!");
static_assert(offsetof(UMeshSpaceDeformerTool, DownIntervalSource) == 0x000120, "Member 'UMeshSpaceDeformerTool::DownIntervalSource' has a wrong offset!");
static_assert(offsetof(UMeshSpaceDeformerTool, ForwardIntervalSource) == 0x000128, "Member 'UMeshSpaceDeformerTool::ForwardIntervalSource' has a wrong offset!");
...
// 0x0590 (0x1130 - 0x0BA0)
class UMeshVertexPaintTool final : public UMeshSculptToolBase
{
public:
	class UPolygroupLayersProperties*             PolygroupLayerProperties;                          // 0x0B98(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UVertexPaintBasicProperties*            BasicProperties;                                   // 0x0BA0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UVertexPaintBrushFilterProperties*      FilterProperties;                                  // 0x0BA8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UVertexColorPaintBrushOpProps*          PaintBrushOpProperties;                            // 0x0BB0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UVertexColorPaintBrushOpProps*          EraseBrushOpProperties;                            // 0x0BB8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UMeshVertexPaintToolQuickActions*       QuickActions;                                      // 0x0BC0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMeshVertexPaintToolUtilityActions*     UtilityActions;                                    // 0x0BC8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class UMeshElementsVisualizer*                MeshElementsDisplay;                               // 0x0BF0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_BF8[0x538];                                    // 0x0BF8(0x0538)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMeshVertexPaintTool) == 0x001130, "Wrong size on UMeshVertexPaintTool");
static_assert(offsetof(UMeshVertexPaintTool, PolygroupLayerProperties) == 0x000B98, "Member 'UMeshVertexPaintTool::PolygroupLayerProperties' has a wrong offset!");
static_assert(offsetof(UMeshVertexPaintTool, BasicProperties) == 0x000BA0, "Member 'UMeshVertexPaintTool::BasicProperties' has a wrong offset!");
static_assert(offsetof(UMeshVertexPaintTool, FilterProperties) == 0x000BA8, "Member 'UMeshVertexPaintTool::FilterProperties' has a wrong offset!");
static_assert(offsetof(UMeshVertexPaintTool, PaintBrushOpProperties) == 0x000BB0, "Member 'UMeshVertexPaintTool::PaintBrushOpProperties' has a wrong offset!");
static_assert(offsetof(UMeshVertexPaintTool, EraseBrushOpProperties) == 0x000BB8, "Member 'UMeshVertexPaintTool::EraseBrushOpProperties' has a wrong offset!");
static_assert(offsetof(UMeshVertexPaintTool, QuickActions) == 0x000BC0, "Member 'UMeshVertexPaintTool::QuickActions' has a wrong offset!");
static_assert(offsetof(UMeshVertexPaintTool, UtilityActions) == 0x000BC8, "Member 'UMeshVertexPaintTool::UtilityActions' has a wrong offset!");
static_assert(offsetof(UMeshVertexPaintTool, PolyLassoMechanic) == 0x000BD8, "Member 'UMeshVertexPaintTool::PolyLassoMechanic' has a wrong offset!");
static_assert(offsetof(UMeshVertexPaintTool, PreviewMeshActor) == 0x000BE0, "Member 'UMeshVertexPaintTool::PreviewMeshActor' has a wrong offset!");
static_assert(offsetof(UMeshVertexPaintTool, DynamicMeshComponent) == 0x000BE8, "Member 'UMeshVertexPaintTool::DynamicMeshComponent' has a wrong offset!");
static_assert(offsetof(UMeshVertexPaintTool, MeshElementsDisplay) == 0x000BF0, "Member 'UMeshVertexPaintTool::MeshElementsDisplay' has a wrong offset!");
...
public:
	...
	class AInternalToolFrameworkActor*            PreviewMeshActor;                                  // 0x0BD0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UDynamicMeshComponent*                  DynamicMeshComponent;                              // 0x0BD8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_BE0[0x910];                                    // 0x0BE0(0x0910)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMeshVertexSculptTool) == 0x0014F0, "Wrong size on UMeshVertexSculptTool");
...
static_assert(offsetof(UMeshVertexSculptTool, PreviewMeshActor) == 0x000BD0, "Member 'UMeshVertexSculptTool::PreviewMeshActor' has a wrong offset!");
static_assert(offsetof(UMeshVertexSculptTool, DynamicMeshComponent) == 0x000BD8, "Member 'UMeshVertexSculptTool::DynamicMeshComponent' has a wrong offset!");
...
public:
	uint8                                         Pad_C0[0x8];                                       // 0x00C0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UMirrorToolProperties*                  Settings;                                          // 0x00C8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class UOnAcceptHandleSourcesProperties*       HandleSourcesProperties;                           // 0x00D8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMirrorToolActionPropertySet*           ToolActions;                                       // 0x00E0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class UDynamicMeshReplacementChangeTarget*> MeshesToMirror;                               // 0x00E8(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<class UMeshOpPreviewWithBackgroundCompute*> Previews;                                     // 0x00F8(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                         Pad_108[0x30];                                     // 0x0108(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	class UConstructionPlaneMechanic*             PlaneMechanic;                                     // 0x0138(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMirrorTool) == 0x000180, "Wrong size on UMirrorTool");
static_assert(offsetof(UMirrorTool, Settings) == 0x0000C8, "Member 'UMirrorTool::Settings' has a wrong offset!");
static_assert(offsetof(UMirrorTool, OutputTypeProperties) == 0x0000D0, "Member 'UMirrorTool::OutputTypeProperties' has a wrong offset!");
static_assert(offsetof(UMirrorTool, HandleSourcesProperties) == 0x0000D8, "Member 'UMirrorTool::HandleSourcesProperties' has a wrong offset!");
static_assert(offsetof(UMirrorTool, ToolActions) == 0x0000E0, "Member 'UMirrorTool::ToolActions' has a wrong offset!");
static_assert(offsetof(UMirrorTool, MeshesToMirror) == 0x0000E8, "Member 'UMirrorTool::MeshesToMirror' has a wrong offset!");
static_assert(offsetof(UMirrorTool, Previews) == 0x0000F8, "Member 'UMirrorTool::Previews' has a wrong offset!");
static_assert(offsetof(UMirrorTool, PlaneMechanic) == 0x000138, "Member 'UMirrorTool::PlaneMechanic' has a wrong offset!");
...
{
public:
	class UOffsetMeshToolProperties*              OffsetProperties;                                  // 0x0410(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UIterativeOffsetProperties*             IterativeProperties;                               // 0x0418(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UImplicitOffsetProperties*              ImplicitProperties;                                // 0x0420(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UOffsetWeightMapSetProperties*          WeightMapProperties;                               // 0x0428(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UOffsetMeshTool) == 0x000430, "Wrong size on UOffsetMeshTool");
static_assert(offsetof(UOffsetMeshTool, OffsetProperties) == 0x000410, "Member 'UOffsetMeshTool::OffsetProperties' has a wrong offset!");
static_assert(offsetof(UOffsetMeshTool, IterativeProperties) == 0x000418, "Member 'UOffsetMeshTool::IterativeProperties' has a wrong offset!");
static_assert(offsetof(UOffsetMeshTool, ImplicitProperties) == 0x000420, "Member 'UOffsetMeshTool::ImplicitProperties' has a wrong offset!");
static_assert(offsetof(UOffsetMeshTool, WeightMapProperties) == 0x000428, "Member 'UOffsetMeshTool::WeightMapProperties' has a wrong offset!");
...
public:
	...
	bool                                          bEnableShowCollision;                              // 0x00C8(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C9[0x7];                                       // 0x00C9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UCollisionGeometryVisualizationProperties) == 0x0000D0, "Wrong size on UCollisionGeometryVisualizationProperties");
...
static_assert(offsetof(UCollisionGeometryVisualizationProperties, bEnableShowCollision) == 0x0000C8, "Member 'UCollisionGeometryVisualizationProperties::bEnableShowCollision' has a wrong offset!");
...
public:
	...
	class UExtractCollisionToolProperties*        Settings;                                          // 0x00C8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class UPhysicsObjectToolPropertySet*          ObjectProps;                                       // 0x00D8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPreviewGeometry*                       PreviewElements;                                   // 0x00E0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPreviewMesh*                           PreviewMesh;                                       // 0x00E8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_F0[0x248];                                     // 0x00F0(0x0248)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UExtractCollisionGeometryTool, OutputTypeProperties) == 0x0000C0, "Member 'UExtractCollisionGeometryTool::OutputTypeProperties' has a wrong offset!");
static_assert(offsetof(UExtractCollisionGeometryTool, Settings) == 0x0000C8, "Member 'UExtractCollisionGeometryTool::Settings' has a wrong offset!");
static_assert(offsetof(UExtractCollisionGeometryTool, VizSettings) == 0x0000D0, "Member 'UExtractCollisionGeometryTool::VizSettings' has a wrong offset!");
static_assert(offsetof(UExtractCollisionGeometryTool, ObjectProps) == 0x0000D8, "Member 'UExtractCollisionGeometryTool::ObjectProps' has a wrong offset!");
static_assert(offsetof(UExtractCollisionGeometryTool, PreviewElements) == 0x0000E0, "Member 'UExtractCollisionGeometryTool::PreviewElements' has a wrong offset!");
static_assert(offsetof(UExtractCollisionGeometryTool, PreviewMesh) == 0x0000E8, "Member 'UExtractCollisionGeometryTool::PreviewMesh' has a wrong offset!");
...
{
public:
	class USmoothMeshToolProperties*              SmoothProperties;                                  // 0x0410(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UIterativeSmoothProperties*             IterativeProperties;                               // 0x0418(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UDiffusionSmoothProperties*             DiffusionProperties;                               // 0x0420(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UImplicitSmoothProperties*              ImplicitProperties;                                // 0x0428(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class USmoothWeightMapSetProperties*          WeightMapProperties;                               // 0x0430(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(USmoothMeshTool) == 0x000440, "Wrong size on USmoothMeshTool");
static_assert(offsetof(USmoothMeshTool, SmoothProperties) == 0x000410, "Member 'USmoothMeshTool::SmoothProperties' has a wrong offset!");
static_assert(offsetof(USmoothMeshTool, IterativeProperties) == 0x000418, "Member 'USmoothMeshTool::IterativeProperties' has a wrong offset!");
static_assert(offsetof(USmoothMeshTool, DiffusionProperties) == 0x000420, "Member 'USmoothMeshTool::DiffusionProperties' has a wrong offset!");
static_assert(offsetof(USmoothMeshTool, ImplicitProperties) == 0x000428, "Member 'USmoothMeshTool::ImplicitProperties' has a wrong offset!");
static_assert(offsetof(USmoothMeshTool, WeightMapProperties) == 0x000430, "Member 'USmoothMeshTool::WeightMapProperties' has a wrong offset!");
...
public:
	...
	bool                                          bSimplifyHulls;                                    // 0x00C3(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         HullTargetFaceCount;                               // 0x00C4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         MaxHullsPerMesh;                                   // 0x00C8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ConvexDecompositionSearchFactor;                   // 0x00CC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AddHullsErrorTolerance;                            // 0x00D0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MinPartThickness;                                  // 0x00D4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bSimplifyPolygons;                                 // 0x00D8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_D9[0x3];                                       // 0x00D9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         HullTolerance;                                     // 0x00DC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EProjectedHullAxis                            SweepAxis;                                         // 0x00E0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         LevelSetResolution;                                // 0x00E4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          bUsingMultipleInputs;                              // 0x00EC(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(USetCollisionGeometryToolProperties, bSimplifyHulls) == 0x0000C3, "Member 'USetCollisionGeometryToolProperties::bSimplifyHulls' has a wrong offset!");
static_assert(offsetof(USetCollisionGeometryToolProperties, HullTargetFaceCount) == 0x0000C4, "Member 'USetCollisionGeometryToolProperties::HullTargetFaceCount' has a wrong offset!");
static_assert(offsetof(USetCollisionGeometryToolProperties, MaxHullsPerMesh) == 0x0000C8, "Member 'USetCollisionGeometryToolProperties::MaxHullsPerMesh' has a wrong offset!");
static_assert(offsetof(USetCollisionGeometryToolProperties, ConvexDecompositionSearchFactor) == 0x0000CC, "Member 'USetCollisionGeometryToolProperties::ConvexDecompositionSearchFactor' has a wrong offset!");
static_assert(offsetof(USetCollisionGeometryToolProperties, AddHullsErrorTolerance) == 0x0000D0, "Member 'USetCollisionGeometryToolProperties::AddHullsErrorTolerance' has a wrong offset!");
static_assert(offsetof(USetCollisionGeometryToolProperties, MinPartThickness) == 0x0000D4, "Member 'USetCollisionGeometryToolProperties::MinPartThickness' has a wrong offset!");
static_assert(offsetof(USetCollisionGeometryToolProperties, bSimplifyPolygons) == 0x0000D8, "Member 'USetCollisionGeometryToolProperties::bSimplifyPolygons' has a wrong offset!");
static_assert(offsetof(USetCollisionGeometryToolProperties, HullTolerance) == 0x0000DC, "Member 'USetCollisionGeometryToolProperties::HullTolerance' has a wrong offset!");
static_assert(offsetof(USetCollisionGeometryToolProperties, SweepAxis) == 0x0000E0, "Member 'USetCollisionGeometryToolProperties::SweepAxis' has a wrong offset!");
static_assert(offsetof(USetCollisionGeometryToolProperties, LevelSetResolution) == 0x0000E4, "Member 'USetCollisionGeometryToolProperties::LevelSetResolution' has a wrong offset!");
...
static_assert(offsetof(USetCollisionGeometryToolProperties, bUsingMultipleInputs) == 0x0000EC, "Member 'USetCollisionGeometryToolProperties::bUsingMultipleInputs' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_F8[0x228];                                     // 0x00F8(0x0228)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USetCollisionGeometryTool) == 0x000320, "Wrong size on USetCollisionGeometryTool");
...
{
public:
	class USimpleCollisionEditorToolActionProperties* ActionProperties;                              // 0x00C0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(USimpleCollisionEditorTool) == 0x0000E8, "Wrong size on USimpleCollisionEditorTool");
static_assert(offsetof(USimpleCollisionEditorTool, ActionProperties) == 0x0000C0, "Member 'USimpleCollisionEditorTool::ActionProperties' has a wrong offset!");
...
{
public:
	class UPlaneCutToolProperties*                BasicProperties;                                   // 0x00C0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UPlaneCutTool, BasicProperties) == 0x0000C0, "Member 'UPlaneCutTool::BasicProperties' has a wrong offset!");
...
{
public:
	class USeamSculptToolProperties*              Settings;                                          // 0x02D0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPreviewGeometry*                       PreviewGeom;                                       // 0x02D8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(USeamSculptTool) == 0x0003C0, "Wrong size on USeamSculptTool");
static_assert(offsetof(USeamSculptTool, Settings) == 0x0002D0, "Member 'USeamSculptTool::Settings' has a wrong offset!");
static_assert(offsetof(USeamSculptTool, PreviewGeom) == 0x0002D8, "Member 'USeamSculptTool::PreviewGeom' has a wrong offset!");
...
public:
	uint8                                         Pad_C0[0x8];                                       // 0x00C0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UTransferMeshToolProperties*            BasicProperties;                                   // 0x00C8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UTransferMeshTool) == 0x0000D0, "Wrong size on UTransferMeshTool");
static_assert(offsetof(UTransferMeshTool, BasicProperties) == 0x0000C8, "Member 'UTransferMeshTool::BasicProperties' has a wrong offset!");
...
{
public:
	class UWeldMeshEdgesToolProperties*           Settings;                                          // 0x00C0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMeshOpPreviewWithBackgroundCompute*    PreviewCompute;                                    // 0x00C8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMeshElementsVisualizer*                MeshElementsDisplay;                               // 0x00D0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UWeldMeshEdgesOperatorFactory*          OperatorFactory;                                   // 0x00D8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UWeldMeshEdgesTool) == 0x0000F0, "Wrong size on UWeldMeshEdgesTool");
static_assert(offsetof(UWeldMeshEdgesTool, Settings) == 0x0000C0, "Member 'UWeldMeshEdgesTool::Settings' has a wrong offset!");
static_assert(offsetof(UWeldMeshEdgesTool, PreviewCompute) == 0x0000C8, "Member 'UWeldMeshEdgesTool::PreviewCompute' has a wrong offset!");
static_assert(offsetof(UWeldMeshEdgesTool, MeshElementsDisplay) == 0x0000D0, "Member 'UWeldMeshEdgesTool::MeshElementsDisplay' has a wrong offset!");
static_assert(offsetof(UWeldMeshEdgesTool, OperatorFactory) == 0x0000D8, "Member 'UWeldMeshEdgesTool::OperatorFactory' has a wrong offset!");
