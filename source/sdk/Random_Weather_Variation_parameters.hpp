...
public:
	...
	TMap<class UUDS_Weather_Settings_C*, double>  K2Node_Select_Default;                             // 0x00D0(0x0050)()
...
static_assert(sizeof(Random_Weather_Variation_C_Create_Composite_Probability_Map) == 0x000178, "Wrong size on Random_Weather_Variation_C_Create_Composite_Probability_Map");
...
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, Temp_int_Variable_1) == 0x0000B0, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::Temp_int_Variable_1' has a wrong offset!");
...
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Add_IntInt_ReturnValue_1) == 0x0000B8, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Add_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Array_Get_Item) == 0x0000C0, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Greater_DoubleDouble_ReturnValue) == 0x0000C8, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Greater_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, K2Node_Select_Default) == 0x0000D0, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Map_Keys_Keys) == 0x000120, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Map_Keys_Keys' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Array_Length_ReturnValue) == 0x000130, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Array_Get_Item_1) == 0x000138, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Less_IntInt_ReturnValue) == 0x000140, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Map_Find_Value) == 0x000148, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Map_Find_Value' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Map_Find_ReturnValue) == 0x000150, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Map_Find_Value_1) == 0x000158, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Map_Find_Value_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Map_Find_ReturnValue_1) == 0x000160, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Map_Find_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Multiply_DoubleDouble_ReturnValue) == 0x000168, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Multiply_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Add_DoubleDouble_ReturnValue) == 0x000170, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Add_DoubleDouble_ReturnValue' has a wrong offset!");
...
public:
	...
	TMap<class UUDS_Weather_Settings_C*, double>  K2Node_CustomEvent_Summer_Probabilities;           // 0x0020(0x0050)()
	TMap<class UUDS_Weather_Settings_C*, double>  K2Node_CustomEvent_Autumn_Probabilities;           // 0x0070(0x0050)()
	TMap<class UUDS_Weather_Settings_C*, double>  K2Node_CustomEvent_Winter_Probabilities;           // 0x00C0(0x0050)()
	TMap<class UUDS_Weather_Settings_C*, double>  K2Node_CustomEvent_Spring_Probabilities;           // 0x0110(0x0050)()
	...
	class UUDS_Weather_Settings_C*                CallFunc_SpawnObject_ReturnValue;                  // 0x0170(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(Random_Weather_Variation_C_ExecuteUbergraph_Random_Weather_Variation) == 0x000180, "Wrong size on Random_Weather_Variation_C_ExecuteUbergraph_Random_Weather_Variation");
...
static_assert(offsetof(Random_Weather_Variation_C_ExecuteUbergraph_Random_Weather_Variation, CallFunc_SpawnObject_ReturnValue) == 0x000170, "Member 'Random_Weather_Variation_C_ExecuteUbergraph_Random_Weather_Variation::CallFunc_SpawnObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_ExecuteUbergraph_Random_Weather_Variation, CallFunc_Delay_Duration_ImplicitCast) == 0x000178, "Member 'Random_Weather_Variation_C_ExecuteUbergraph_Random_Weather_Variation::CallFunc_Delay_Duration_ImplicitCast' has a wrong offset!");
...
static_assert(sizeof(Random_Weather_Variation_C_Increment_Random_Weather) == 0x000050, "Wrong size on Random_Weather_Variation_C_Increment_Random_Weather");
...
static_assert(offsetof(Random_Weather_Variation_C_Increment_Random_Weather, CallFunc_IsValid_ReturnValue) == 0x000008, "Member 'Random_Weather_Variation_C_Increment_Random_Weather::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Increment_Random_Weather, CallFunc_IsValid_ReturnValue_1) == 0x000009, "Member 'Random_Weather_Variation_C_Increment_Random_Weather::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Increment_Random_Weather, CallFunc_BooleanAND_ReturnValue) == 0x00000A, "Member 'Random_Weather_Variation_C_Increment_Random_Weather::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Random_Weather_Variation_C_Increment_Random_Weather, CallFunc_Ease_ReturnValue) == 0x000018, "Member 'Random_Weather_Variation_C_Increment_Random_Weather::CallFunc_Ease_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Increment_Random_Weather, CallFunc_GetWorldDeltaSeconds_ReturnValue) == 0x000020, "Member 'Random_Weather_Variation_C_Increment_Random_Weather::CallFunc_GetWorldDeltaSeconds_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Increment_Random_Weather, CallFunc_Multiply_DoubleDouble_ReturnValue) == 0x000028, "Member 'Random_Weather_Variation_C_Increment_Random_Weather::CallFunc_Multiply_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Increment_Random_Weather, CallFunc_Divide_DoubleDouble_ReturnValue) == 0x000030, "Member 'Random_Weather_Variation_C_Increment_Random_Weather::CallFunc_Divide_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Increment_Random_Weather, CallFunc_Divide_DoubleDouble_ReturnValue_1) == 0x000038, "Member 'Random_Weather_Variation_C_Increment_Random_Weather::CallFunc_Divide_DoubleDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Increment_Random_Weather, CallFunc_Add_DoubleDouble_ReturnValue) == 0x000040, "Member 'Random_Weather_Variation_C_Increment_Random_Weather::CallFunc_Add_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Increment_Random_Weather, CallFunc_FClamp_ReturnValue) == 0x000048, "Member 'Random_Weather_Variation_C_Increment_Random_Weather::CallFunc_FClamp_ReturnValue' has a wrong offset!");
