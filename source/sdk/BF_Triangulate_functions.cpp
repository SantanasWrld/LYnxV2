...
void UBF_Triangulate_C::TriangulatePolygons(TArray<struct FVector>& Vertices, class UObject* __WorldContext, TArray<int32>* Triangles)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("BF_Triangulate_C", "TriangulatePolygons");

	Params::BF_Triangulate_C_TriangulatePolygons Parms{};
