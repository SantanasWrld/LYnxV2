...
namespace Offsets
{
	constexpr int32 GObjects          = 0x071A5A30;
	constexpr int32 AppendString      = 0x00C80930;
	constexpr int32 GNames            = 0x070FF680;
	constexpr int32 GWorld            = 0x07312908;
	constexpr int32 ProcessEvent      = 0x00E3B810;
