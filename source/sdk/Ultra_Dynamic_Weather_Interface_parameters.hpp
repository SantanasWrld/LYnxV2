...
{
public:
	struct FUDS_and_UDW_State                     State;                                             // 0x0000(0x0118)(BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
};
...
static_assert(sizeof(Ultra_Dynamic_Weather_Interface_C_Apply_State) == 0x000118, "Wrong size on Ultra_Dynamic_Weather_Interface_C_Apply_State");
...
{
public:
	struct FUDS_and_UDW_State                     UDW_State;                                         // 0x0000(0x0118)(Parm, OutParm, HasGetValueTypeHash)
};
...
static_assert(sizeof(Ultra_Dynamic_Weather_Interface_C_Get_State_for_Saving) == 0x000118, "Wrong size on Ultra_Dynamic_Weather_Interface_C_Get_State_for_Saving");
